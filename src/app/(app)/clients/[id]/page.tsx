...
import { listInvoicesByClient } from "@/lib/db/queries/invoices";
...
export default async function ClientDetailPage({
  ...
  const invoices = await listInvoicesByClient(id);
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <NewInvoiceButton clientId={client.id} />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <ActivityLog subjectType="client" subjectId={client.id} />
        </CardContent>
      </Card>
    </div>
  );
