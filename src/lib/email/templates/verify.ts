...
export function verifyEmail({ name, url }: VerifyEmailInput): RenderedEmail {
  ...
  const subject = "Confirm your email for AgenticBuilder";
  const text = [
    `Hi ${safeName},`,
    "",
    "Confirm your email to finish setting up your AgenticBuilder account:",
    url,
    "",
  ...
  const html = `
    <div style="font-family:ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,sans-serif;color:#111;line-height:1.5">
      ...
      <p>Confirm your email to finish setting up your AgenticBuilder account.</p>
      <p>
